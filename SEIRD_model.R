...
epidemic <- function(i, u){  # i = IMD decile, u = urban (T)/rural (F)
...
# matplot(epidemic(3, T)[1:120,2:8], type="l", lty=1, lwd=2, 
#         xlab="Day of outbreak",col=c(2:7,1), 
#         ylab='Proportion of population')
# legend <- colnames(epidemic(1, T))[2:8]
# legend("right", legend=legend, col=c(2:7,1), 
#        lty=1, lwd=2)

### age-specific outcomes for later age-standardisation

epidemic_age_standard <- function(i, u){  # i = IMD decile, u = urban (T)/rural (F)
